...
private final XboxController driverControler = new XboxController(0);
  ...
  */
  private RobotContainer() {
    ...
    m_armElevator.setDefaultCommand(new ArmElevatorRun(() -> -co_DriverController.getRawAxis(0), m_armElevator));
...
extensionRetract_Btn.whileTrue(new ArmExtensionRun(() -> -0.5, m_armExtension).withInterruptBehavior(InterruptionBehavior.kCancelSelf));
                        
final JoystickButton extensionExt_Btn = new JoystickButton(co_DriverController, 3);        
extensionExt_Btn.whileTrue(new ArmExtensionRun(() -> 0.5, m_armExtension).withInterruptBehavior(InterruptionBehavior.kCancelSelf));
                        
final JoystickButton elevatorLower_Btn = new JoystickButton(co_DriverController, 2);        
elevatorLower_Btn.whileTrue(new ArmElevatorRun(() -> -0.5, m_armElevator).withInterruptBehavior(InterruptionBehavior.kCancelSelf));
                        
final JoystickButton elevatorRaise_btn = new JoystickButton(co_DriverController, 1);        
elevatorRaise_btn.whileTrue(new ArmElevatorRun(() -> 0.5, m_armElevator).withInterruptBehavior(InterruptionBehavior.kCancelSelf));

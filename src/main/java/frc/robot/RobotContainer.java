...
// The robot's subsystems
    public final Paddle m_paddle = new Paddle();
...
private SendableChooser<String> autoChooser = new SendableChooser<>();
  ...
  */
  public RobotContainer() {
    ...
    m_armElevator.setDefaultCommand(new ArmElevatorRun(() -> MathUtil.applyDeadband(-co_DriverController.getRawAxis(0), 0.2), m_armElevator));
...
rel_Button.whileTrue(new IntakeInCommand( m_intake));
...
if (autoChooser.getSelected().toString().equals("CenterBalance"))
    return new AutoCommand(m_drivertrain, m_armElevator, m_armExtension, m_paddle);
else if(autoChooser.getSelected().equals("CableSideAuto"))
     return new CableSideAuto(m_drivertrain, m_armElevator, m_armExtension, m_paddle);
else if(autoChooser.getSelected().equals("OverAndBackAuto"))
     return new OverAndBackAuto(m_drivertrain, m_armElevator, m_armExtension, m_paddle);
